...
(function () {
  ...
  /* @ngInject */
  function SpecificServerStatusApi($http, serverApiUrl, $timeout) {
    var self = this;
    ...
    this.testNamesTableData = {
      data: 'serverStatusCtrl.specificServerStatusApi.testNames',
      columnDefs: [
    ...
    this.runsOfChosenTestTableData = {
      data: 'serverStatusCtrl.specificServerStatusApi.runsOfSelectedTestTestedServerData',
      columnDefs: 'serverStatusCtrl.specificServerStatusApi.getColumnDefsForRunsOfSelectedTestArr(serverStatusCtrl.specificServerStatusApi.runsOfSelectedTestTestedServerData, true)',
      multiSelect: false,
      init: resizeGridOnEventData,
    ...
    this.runsTableData = {
      data: 'serverStatusCtrl.specificServerStatusApi.runs',
      columnDefs: [
    ...
    this.testsOfSelectedRunBasicTableData = {
      data: 'serverStatusCtrl.specificServerStatusApi.testsOfSelectedRunData',
      columnDefs: [
    ...
    this.serversOfSelectedTestOfSelectedRunTableData = {
      data: 'serverStatusCtrl.specificServerStatusApi.serversDataOfTestOfSelectedRun',
      rowTemplate: '' +
        ...
        '</div>' +
        '</div>',
      columnDefs: 'serverStatusCtrl.specificServerStatusApi.getColumnDefsForRunsOfSelectedTestArr(serverStatusCtrl.specificServerStatusApi.serversDataOfTestOfSelectedRun)',
    ...
    this.getColumnDefsForRunsOfSelectedTestArr = function (runsOfSelectedTestArr, withoutServerHostName) {
      ...
      for (var key in exampleRow) {
        ...
        if (key === 'runEndTime') {
          ...
          columnObj.cellTemplate = '<div class="ngCellText" ng-click="serverStatusCtrl.specificServerStatusApi.buildChartByAttribute(col.colDef.field, col.colDef.displayName)">{{row.entity[col.field]}}</div>';
        }
  ...
  angular
    ...
    .service('specificServerStatusApi', SpecificServerStatusApi);
