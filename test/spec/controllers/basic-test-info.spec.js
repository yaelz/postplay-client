...
//      expect(BasicTestInfoController.artifactsTablesEntity).toBeDefined();
//      expect(BasicTestInfoController.artifactsTablesEntity.failedAndChosenWrappedArtifacts).toEqual([]);
//      expect(BasicTestInfoController.artifactsTablesEntity.passedWrappedArtifacts).toEqual([]);
//    });
